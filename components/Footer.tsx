...
const FooterLinks = ({ heading, items } : {heading:string, items: string[]}) => (
...
const Footer = () => {
  ...
  return (
    <footer className="dark:bg-black flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
