...
interface ISearchBar {
    activeSelect: any, 
    setActiveSelect: (tag: string) => any, 
    handleSearch: (search: string) => any, 
    clearSearch: () => any
}

const SearchBar = ({ activeSelect, setActiveSelect, handleSearch, clearSearch } : ISearchBar) => {
